...
func (t *BM25SearchTool) Description() string {
	...
	return "Searches the tool library for useful tools. Use this when you don't have a tool for a specific task. Returns a list of tools that match the description"
}
